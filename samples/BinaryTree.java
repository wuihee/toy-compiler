...
class Tree {
    ...
    public boolean SetHas_Left(boolean val) {
    	System.out.println(99990000);  // Add this
    	has_left = val;
    	System.out.println(99990001);  // Add this
    	return true;
    }
    ...
    public boolean Insert(int v_key) {
        ...
        while (cont) {
            ...
            if (v_key < key_aux) {
                if (current_node.GetHas_Left()) current_node =
                ...
                if (current_node.GetHas_Right()) current_node =
    ...
    public int Search(int v_key) {
        ...
        while (cont) {
            key_aux = current_node.GetKey();
            if (v_key < key_aux) if (current_node.GetHas_Left()) current_node =
                current_node.GetLeft();
            else cont = false;
            else if (key_aux < v_key) if (
                current_node.GetHas_Right()
            ) current_node = current_node.GetRight();
            else cont = false;
            else {
